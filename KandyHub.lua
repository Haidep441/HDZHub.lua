...
ImageButton.Image = "http://www.roblox.com/asset/?id=71295544161205"
...
local Tabs = {
    ...
    Settings = Window:AddTab({ Title = "Cài Đặt⚙️", Icon = "" }),
}
