...
local Window = OrionLib:MakeWindow({Name = "HESI HUB", HidePremium = false, IntroText = "HESIHUB Library", SaveConfig = true, ConfigFolder = "HESI HUB"})
...
OrionLib:MakeNotification({
	Name = "HESI HUB",
	Content = "HESI HUB Not Skidder, Please don't says",
	Image = "rbxassetid://4483345998",
	Time = 25
})
...
W:AddLabel("Script By HESI")

local Section = W:AddSection({
    Name = "Update"
})

W:AddLabel("[+] HESI HUB is back!")
